...
<?= $this->section('Title') ?>Regimen Fiscal<?= $this->endSection() ?>

<?= $this->section('MainContent'); ?>

<div class="app-title">
    <div>
        <h1><i class="fa fa-book"></i>    Régimen Fiscal</h1>
        <br />
        <br />
        <button class="btn btn-primary" type="button" id="btn_agregar_regimen_fiscal"><i class="fas fa-plus-circle"></i> Nuevo</button>
    </div>
    <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Home"><i class="fa fa-home fa-lg"></i></a></li>
        <li class="breadcrumb-item"><a href="#">Regimen Fiscal</a></li>
    </ul>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="table-regimen_fiscal">
                    <thead>
...
<script src="<?= base_url(); ?>Assets/js/functions_regimen_fiscal.js"></script>
<?= $this->endSection(); ?>
<div id="modalDatosActividadEconomica" class="modal fade">
    <div class="modal-dialog modal-lg">
        <form id="formModalActividadEconomica" class="modal-content" method="POST"
            onsubmit="return AgregarActualizarActividadEconomica(<?php echo $id_actividad_economica ?>)" enctype="multipart/form-data">
            <div class="modal-header">
                <h4 class="modal-title">
                    <?php echo $accion ?> Actividad Económica
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4" id="div_estatus">
                        <div class="form-group">
                            <label class="control-label" for="ddl_estatus_actividad_economica">Estatus:</label>
                            <select class="form-control" name="ddl_estatus_actividad_economica" id="ddl_estatus_actividad_economica"
                                tabindex="3">

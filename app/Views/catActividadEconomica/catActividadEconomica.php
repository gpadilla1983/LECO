...
<?= $this->section('Title') ?>Actividad Económica<?= $this->endSection() ?>

<?= $this->section('MainContent'); ?>

<div class="app-title">
    <div>
        <h1><i class="fas fa-store-alt"></i>    Actividad Económica</h1>
        <br />
        <br />
        <button class="btn btn-primary" type="button" id="btn_agregar_actividad_economica"><i class="fas fa-plus-circle"></i> Nuevo</button>
    </div>
    <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Home"><i class="fa fa-home fa-lg"></i></a></li>
        <li class="breadcrumb-item"><a href="#">Actividad Económica</a></li>
    </ul>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="table-actividad_economica">
                    <thead>
...
<script src="<?= base_url(); ?>Assets/js/functions_actividad_economica.js"></script>
<?= $this->endSection(); ?>
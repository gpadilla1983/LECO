<div id="modalDatosTipoCasoLegal" class="modal fade">
    <div class="modal-dialog modal-lg">
        <form id="formModalTipoCasoLegal" class="modal-content" method="POST"
            onsubmit="return AgregarActualizarTipoCasoLegal(<?php echo $id_tipo_caso_legal ?>)" enctype="multipart/form-data">
            <div class="modal-header">
                <h4 class="modal-title">
                    <?php echo $accion ?> Tipo Caso Legal
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4" id="div_estatus">
                        <div class="form-group">
                            <label class="control-label" for="ddl_estatus_tipo_caso_legal">Estatus:</label>
                            <select class="form-control" name="ddl_estatus_tipo_caso_legal" id="ddl_estatus_tipo_caso_legal"
                                tabindex="3">

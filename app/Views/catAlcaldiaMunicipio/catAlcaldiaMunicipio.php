...
<?= $this->section('Title') ?>Ciudad<?= $this->endSection() ?>

<?= $this->section('MainContent'); ?>

<div class="app-title">
    <div>
        <h1><i class="fas fa-map-marker-alt"></i>    Ciudad</h1>
        <br />
        <br />
        <button class="btn btn-primary" type="button" id="btn_agregar_alcaldia_municipio"><i class="fas fa-plus-circle"></i> Nuevo</button>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="table-alcaldia_municipio">
                    <thead>
...
<script src="<?= base_url(); ?>Assets/js/functions_alcaldia_municipio.js"></script>
<?= $this->endSection(); ?>
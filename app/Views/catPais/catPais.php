...
<?= $this->section('Title') ?>País<?= $this->endSection() ?>

<?= $this->section('MainContent'); ?>

<div class="app-title">
    <div>
        <h1><i class="fas fa-flag"></i>    País</h1>
        <br />
        <br />
        <button class="btn btn-primary" type="button" id="btn_agregar_pais"><i class="fas fa-plus-circle"></i> Nuevo</button>
    </div>
...
<script src="<?= base_url(); ?>Assets/js/functions_pais.js"></script>
<?= $this->endSection(); ?>
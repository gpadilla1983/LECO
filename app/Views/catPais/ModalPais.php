<div id="modalDatosPais" class="modal fade">
    <div class="modal-dialog modal-lg">
        <form id="formModalPais" class="modal-content" method="POST"
            onsubmit="return AgregarActualizarPais(<?php echo $id_pais ?>)" enctype="multipart/form-data">
            <div class="modal-header">
                <h4 class="modal-title">
                    <?php echo $accion ?> País
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4" id="div_estatus">
                        <div class="form-group">
                            <label class="control-label" for="ddl_estatus_pais">Estatus:</label>
                            <select class="form-control" name="ddl_estatus_pais" id="ddl_estatus_pais"
                                tabindex="3">

...
<?= $this->section('Title') ?>Relación Cliente Responsable<?= $this->endSection() ?>

<?= $this->section('MainContent'); ?>
<div class="app-title">
    <div>
        <h1><i class="fas fa-id-badge"></i>    Relación Cliente Responsable</h1>
        <br />
        <br />
        <!--button class="btn btn-primary" type="button" id="btn_agregar_cliente_tresponsable"><i class="fas fa-plus-circle"></i> Nuevo</button-->
    </div>
    <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Home"><i class="fa fa-home fa-lg"></i></a></li>
        <li class="breadcrumb-item"><a href="#">Relación Cliente Responsable</a></li>
    </ul>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="table-cliente_tresponsable">
                    <thead>
...
<script src="<?= base_url(); ?>Assets/js/functions_cliente_tresponsable.js"></script>
<?= $this->endSection(); ?>
...
<?= $this->section('Title') ?>Relación Cliente Socio<?= $this->endSection() ?>

<?= $this->section('MainContent'); ?>
<div class="app-title">
    <div>
        <h1><i class="fas fa-user-tie"></i>    Relación Cliente Socio</h1>
        <br />
        <br />
        <!--button class="btn btn-primary" type="button" id="btn_agregar_cliente_socio"><i class="fas fa-plus-circle"></i> Nuevo</button-->
    </div>
    <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Home"><i class="fa fa-home fa-lg"></i></a></li>
        <li class="breadcrumb-item"><a href="#">Relación Cliente Socio</a></li>
    </ul>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="table-cliente_socio">
                    <thead>
...
<script src="<?= base_url(); ?>Assets/js/functions_cliente_socio.js"></script>
<?= $this->endSection(); ?>
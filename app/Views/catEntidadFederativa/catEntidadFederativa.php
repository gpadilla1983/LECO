...
<?= $this->section('Title') ?>Estado<?= $this->endSection() ?>

<?= $this->section('MainContent'); ?>

<div class="app-title">
    <div>
        <h1><i class="fas fa-map"></i>    Estado</h1>
        <br />
        <br />
        <button class="btn btn-primary" type="button" id="btn_agregar_entidad_federativa"><i class="fas fa-plus-circle"></i> Nuevo</button>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="table-entidad_federativa">
                    <thead>
...
<script src="<?= base_url(); ?>Assets/js/functions_entidad_federativa.js"></script>
<?= $this->endSection(); ?>
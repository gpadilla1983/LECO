...
<?= $this->section('Title') ?>Juzgado<?= $this->endSection() ?>

<?= $this->section('MainContent'); ?>

<div class="app-title">
    <div>
        <h1><i class="fas fa-landmark"></i>    Juzgado</h1>
        <br />
        <br />
        <button class="btn btn-primary" type="button" id="btn_agregar_juzgado"><i class="fas fa-plus-circle"></i> Nuevo</button>
    </div>
    <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Home"><i class="fa fa-home fa-lg"></i></a></li>
        <li class="breadcrumb-item"><a href="#">Juzgado</a></li>
    </ul>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="table-juzgado">
                    <thead>
                        <tr style="background-color:gray; color:white">
                            <th class="text-center">Núm.</th>
                            <th class="text-center">Núm. del Juzgado</th>
                            <th class="text-center">Datos del Juzgado</th>
...
<script src="<?= base_url(); ?>Assets/js/functions_juzgado.js"></script>
<?= $this->endSection(); ?>
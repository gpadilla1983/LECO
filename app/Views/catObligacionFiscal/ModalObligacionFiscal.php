<div id="modalDatosObligacionFisc" class="modal fade">
    <div class="modal-dialog modal-lg">
        <form id="formModalObligacionFisc" class="modal-content" method="POST"
            onsubmit="return AgregarActualizarObligacionFisc(<?php echo $id_obligacion_fiscal ?>)" enctype="multipart/form-data">
            <div class="modal-header">
                <h4 class="modal-title">
                    <?php echo $accion ?> Obligación Fiscal
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4" id="div_estatus">
                        <div class="form-group">
                            <label class="control-label" for="ddl_estatus_obligacion_fiscal">Estatus:</label>
                            <select class="form-control" name="ddl_estatus_obligacion_fiscal" id="ddl_estatus_obligacion_fiscal"
                                tabindex="3">

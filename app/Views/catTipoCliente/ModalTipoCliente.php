<div id="modalDatosTipoCliente" class="modal fade">
    <div class="modal-dialog modal-lg">
        <form id="formModalTipoCliente" class="modal-content" method="POST"
            onsubmit="return AgregarActualizarTipoCliente(<?php echo $id_tipo_cliente ?>)" enctype="multipart/form-data">
            <div class="modal-header">
                <h4 class="modal-title">
                    <?php echo $accion ?> Tipo Cliente
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4" id="div_estatus">
                        <div class="form-group">
                            <label class="control-label" for="ddl_estatus_tipo_cliente">Estatus:</label>
                            <select class="form-control" name="ddl_estatus_tipo_cliente" id="ddl_estatus_tipo_cliente"
                                tabindex="3">

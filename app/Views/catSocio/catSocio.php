...
<?= $this->section('Title') ?>Socio<?= $this->endSection() ?>
...
<div class="app-title">
    <div>
        <h1><i class="fas fa-handshake"></i>    Socio</h1>
        <br />
        <br />
        <button class="btn btn-primary" type="button" id="btn_agregar_socio"><i class="fas fa-plus-circle"></i> Nuevo</button>
    </div>
    <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Home"><i class="fa fa-home fa-lg"></i></a></li>
        <li class="breadcrumb-item"><a href="#">Socio</a></li>
    </ul>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="table-socio">
                    <thead>
...
<script src="<?= base_url(); ?>Assets/js/functions_socio.js"></script>
<?= $this->endSection(); ?>